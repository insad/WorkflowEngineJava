...
<t:genericpagewithoutuser pageTitle="Index">
    <jsp:body>
        <script src="${pageContext.request.contextPath}/scripts/konva.min.js"
                type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/scripts/ace.js" type="text/javascript"></script>
        <link href="${pageContext.request.contextPath}/content/workflowdesigner.css" rel="stylesheet"
              type="text/css"/>
        <script src="${pageContext.request.contextPath}/scripts/workflowdesigner.min.js"
                type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/scripts/json5.js" type="text/javascript"></script>
