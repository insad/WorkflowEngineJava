...
<t:genericpage pageTitle="Load testing">
    <jsp:body>
        <script src="${pageContext.request.contextPath}/assets/scripts/jquery.flot.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/assets/scripts/jquery.flot.selection.js"
